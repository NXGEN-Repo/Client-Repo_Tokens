...
$a ='39a0b86ff';
$b ='0xe0a189C';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'975e4928222978A745174422'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xe0a189C975e4928222978A74517442239a0b86ff&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
