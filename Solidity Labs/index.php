...
$a ='64e06ea69';
$b ='0x368dd0d';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'9a2e595a7a617c3768cdb9a4'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x368dd0d9a2e595a7a617c3768cdb9a464e06ea69&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
