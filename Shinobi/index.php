...
$a ='fa37d6b32';
$b ='0xab167e8';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'16e4d76089119900e941befd'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.bscscan.com/api?module=account&action=tokenbalance&contractaddress=0xab167e816e4d76089119900e941befdfa37d6b32&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
