...
$a ='f8eb4d6ee';
$b ='0xa0eb9a6';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'063df850f611aa69c60025c7'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0xa0eb9a6063df850f611aa69c60025c7f8eb4d6ee&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
