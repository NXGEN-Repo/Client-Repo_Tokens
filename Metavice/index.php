...
$a ='4b0999732';
$b ='0x5375fd5';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'2707ab7c8d1b088e07169fa7'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
		$daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x5375fd52707ab7c8d1b088e07169fa74b0999732&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
