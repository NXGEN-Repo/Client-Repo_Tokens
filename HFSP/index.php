...
$a ='360E2f353';
$b ='0x7343581';
$api_url = 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress='.$b.'f55146951B0F678dC6CFA8fD'.$a.'&apikey='.$api_key;
...
function deadtoken($deadaddress, $totalsupply, $real_token_p1, $real_token_p2, $api_key) {
  $daed = 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x7343581f55146951B0F678dC6CFA8fD360E2f353&address='.$deadaddress.'&tag=latest&apikey='.$api_key;
